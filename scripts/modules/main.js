...
// Define function to generate prompt accorting to request of user. Either normal summary or bullets points. It takes two string parameter, one is type of response we want and other is text that we want to process.
